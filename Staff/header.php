...
<body>
  ...
  <header>
    <!-- Sidebar -->
    <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-success shadow">
      <div class="position-sticky">
        <div class="list-group list-group-flush mx-2 mt-4">
          ...
          <a href="editprofile.php" class="list-group-item list-group-item-action py-2 ripple">
            <i class="fas fa-file-alt fa-fw me-2"></i><span>My Profile</span>
          </a>
          <a href="viewAssignedDuties.php" class="list-group-item list-group-item-action py-2 ripple">
            <i class="fas fa-pen fa-fw me-2"></i><span>Assigned Duties</span>
          </a>
          <a href="viewDutyHistory.php" class="list-group-item list-group-item-action py-2 ripple">
            <i class="fas fa-file-alt fa-fw me-2"></i><span>View Duty History</span>
          </a>
        </div>
      </div>
    </nav>
      ...
      <div class="container-fluid">
        ...
        <ul class="navbar-nav ms-auto d-flex flex-row">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuLink">
              <li><a class="dropdown-item" href="editprofile.php">My profile</a></li>
              <!-- <li><a class="dropdown-item" href="editprofile.php">Settings</a></li> -->
              <li><a class="dropdown-item" onclick="logoutconfirm()">Logout</a></li>
              <script>
