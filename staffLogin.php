...
<div class="container ">
    <div class="shadow card mt-5 pb-5" style="width:40%; margin:auto;">
        ...
        <form role="form" method="post" action="transacStaff.php">
            <!--Section: Content-->
            <h4 class="pt-4 pb-4 text-center card-header"><strong>Staff's login</strong></h4>
                    ...
                    <div class="row mb-4">
                        <div class="col">
                            <div class="form-outline">
                                <input type="text" id="form3Example3" name="staffId" class="form-control" />
